'''Apresente uma codificação em Python que utilizando o conceito de Multilistas represente um sistema de biblioteca. O sistema terá que cadastrar e remover alunos e livros. Todo livro/aluno possui um nome. Todo aluno pode possuir nenhum, um ou mais livros cadastrados; a biblioteca pode possuir nenhum, um ou mais alunos. O sistema terá que apresentar os livros cadastrados em um aluno.'''
...
bibli.relatorio()
bibli.removerLivro("Júnior", 3, "LOTR", 1955)
bibli.relatorio()